...
# S3, S4, reference class (RC or R5) and the most 
# recently introduced R6.
...
# of classes are required and the objects have clearly defined 
...
# an object might have multiple classes and 
...
# this is polymorphism - one function (print) behaves differently
...
# add the method mean.client() simply
