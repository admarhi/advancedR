...
#           7. Benchmarking and code profiling            #
...
# create vector, iterate through and check if a package is installed, otherwise 
# install it
...
m3
m4
# up to 10 decimal places everything is ok 
...
# to elements of more complex objects (see exercise 7.2)
