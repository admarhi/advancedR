...
# resulting function can be used like a normal R function
...
# as we used if() function inside, the result is based only
# on the first argument of the input vector.
# we will use the function for each value of the vector 
# separately with the help of sapply() or map() from purrr package
